      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-6 mb-6">
          <div className="flex items-start justify-between gap-4 flex-wrap">
            ...
            {/* Opens India Post's own tracking site in a new tab so the
                user can look up their consignment number directly. */}
            <a
              href="https://www.indiapost.gov.in/"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 bg-[#335B6E] hover:bg-[#274550] text-white text-sm font-semibold px-4 py-2.5 rounded-lg transition-colors whitespace-nowrap"
            >
        ...
        <ShippingTracker status={order.status} shippingStatus={order.shipping_status} />
