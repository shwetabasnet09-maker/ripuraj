        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="/about-us" className="text-gray-200 hover:text-white transition-colors">About</a></li>
              <li><a href="/shop" className="text-gray-200 hover:text-white transition-colors">Shop</a></li>
              <li><a href="/product" className="text-gray-200 hover:text-white transition-colors">Product</a></li>
              <li><a href="/event" className="text-gray-200 hover:text-white transition-colors">Event</a></li>
              <li><a href="/winner-list" className="text-gray-200 hover:text-white transition-colors">Contact</a></li>
              <li><a href="/contact-us" className="text-gray-200 hover:text-white transition-colors">CashBack Info</a></li>
            </ul>
          </div>
        ...
        <div className="container mx-auto px-6 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              <a href="https://www.facebook.com/RipurajRice/" className="w-10 h-10 bg-white rounded-full flex items-center justify-center hover:bg-gray-100 transition-colors">
              ...
              <a href="https://www.instagram.com/ripurajagro/" className="w-10 h-10 bg-white rounded-full flex items-center justify-center hover:bg-gray-100 transition-colors">
                <svg className="w-5 h-5 text-[#2d5a6b]" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://www.linkedin.com/company/ripuraj-agro-pvt-ltd/?originalSubdomain=in" className="w-10 h-10 bg-white rounded-full flex items-center justify-center hover:bg-gray-100 transition-colors">
                <svg className="w-5 h-5 text-[#2d5a6b]" fill="currentColor" viewBox="0 0 24 24">
