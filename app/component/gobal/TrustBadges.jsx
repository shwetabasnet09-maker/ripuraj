...
const TrustBadges = () => {
  return (
    <div className="bg-amber-50 py-16 px-4">
      <div className="wrapper text-center text-black">
        {/* Available At Badge */}
        <div className="inline-block bg-white px-6 py-2 rounded-full text-[18px] font-medium mb-6 font-bold">
          Available At
        </div>
        ...
        <div className="flex flex-wrap items-center justify-center gap-8 md:gap-12">
          ...
          <div className="flex items-center">
            <Image 
              src="/blinkit.svg" // put your image path here
              alt="Blinkit Logo"
              width={100}
              height={40}
            />
